...
family_rules = [same_identity_rule, brother_rule, sister_rule, mother_rule, father_rule, daughter_rule, son_rule, sibling_rule, cousin_rule, grandparent_rule, grandchild_rule]                    # fill me in
...
WHAT_I_FOUND_INTERESTING = 'evrithing'
